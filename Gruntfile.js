// Generated on 2016-01-28 using generator-angular-fullstack 3.1.1
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      livereload: {
        files: [
          ...
          '<%= yeoman.client %>/components/resources/{,*/}*.json'
        ],
        options: {
          livereload: true
        }
    ...
    ngconstant: {
      options: {
        name: 'angularMaterialFullstackApp.constants',
